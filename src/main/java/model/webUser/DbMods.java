...
public class DbMods {
    ...
    public static StringData getMisc(DbConn dbc, String minMemberFee, String maxBirthday) {
        ...
        try {
            ...
            if (results.next()) {
                ...
                sd.errorMsg = "No records found.";
            }
            results.close();
            stmt.close();
        } catch (Exception e) {
            sd.errorMsg = "Exception while searching for web user: " + e.getMessage();
        }
    ...
    private static StringData validate(StringData inputData) {
        ...
        errorMsgs.birthday = Validate.dateMsg(inputData.birthday, true);
            ...
            public static StringData delete(DbConn dbc, String userId) {
                ...
                try {
                    ...
                    if (e.getMessage().contains("foreign key")) {
                        sd.errorMsg = "This user cannot be deleted because it has related records. " + e.getMessage();
                    } else {
